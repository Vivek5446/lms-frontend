      ...
      <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 32 }}>
        ...
        <div>
          ...
          <p style={{ margin: 0, fontSize: 13, color: "#6B7280", marginTop: 2 }}>
            Let&apos;s start with the essentials âœ¨
          </p>
        </div>
      </div>
        ...
        >
          ...
          {value.thumbnail?.previewUrl ? (
            <div style={{ position: "relative", display: "inline-block", width: "100%" }}>
              <img src={value.thumbnail.previewUrl} alt="Thumbnail" style={{ width: "100%", maxHeight: 192, objectFit: "cover", borderRadius: 12 }} />
              <button
                onClick={(event) => {
