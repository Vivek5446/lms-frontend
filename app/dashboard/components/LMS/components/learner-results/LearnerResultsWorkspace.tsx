        ...
        <DrawerBody py={5}>
          {isLoading && !detail ? (
            ...
            <Stack spacing={5}>
              ...
              <Box>
                <Heading size="xs" mb={3}>Module completion</Heading>
                <Stack spacing={3}>
                  {(detail.modules || []).length ? (
                    detail.modules?.map((module) => (
                      <Box key={module.moduleId} borderWidth="1px" borderColor={borderColor} borderRadius="xl" p={3}>
                        <Flex justify="space-between" gap={3}>
                          <Box minW={0}>
                          ...
                          <Text fontSize="sm" fontWeight="bold">{Math.round(module.progress || 0)}%</Text>
                        </Flex>
              ...
              <Box>
                <Heading size="xs" mb={3}>Submitted answers</Heading>
                <ScormQuizReviewContent
                  sections={detail.answerSections || []}
                  mode="learner"
                  emptyState="No submitted answers are available for this learner and course."
                  progressSummary={{
